...
@section('content')
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            {!! Form::open(array('url'=>'administracion/users', 'method'=>'POST', 'autocomplete'=>'off')) !!}
                {{ Form::token() }}
                
                <div class="form-group">
                    <label for="name">Nombre*</label>
                    <input type="text" name="name" class="form-control" placeholder="Nombre completo" value="{{ old('name') }}"></input>
                </div>

                <div class="form-group">
                    <label for="email">Correo electrónico*</label>
                    <input type="email" name="email" class="form-control" placeholder="ejemplo@correo.com" value="{{ old('email') }}"></input>
                </div>

                <div class="form-group">
                    <label for="telefono">Teléfono</label>
                    <input type="text" name="telefono" class="form-control" placeholder="Teléfono de la empresa" value="{{ old('telefono') }}"></input>
                </div>

                <div class="form-group">
                    <label for="web">Sitio web</label>
                    <input type="text" name="web" class="form-control" placeholder="Sitio web de la empresa" value="{{ old('web') }}"></input>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="empresa" class="form-control" placeholder="Nombre de la empresa" value="{{ old('empresa') }}"></input>
                </div>
                ...
                <div class="form-group">
                    ...
                    ], null, ['class' => 'form-control', 'placeholder' => '-- Ubicación de la empresa --']); !!}
                </div>

                <div class="form-group">
                    <label for="direccion">Dirección</label>
                    <input type="text" name="direccion" class="form-control" placeholder="Dirección de la empresa" value="{{ old('direccion') }}"></input>
                </div>

                <div class="form-group">
                    <label for="sector">Tipo de usuario*</label>
                    {!! Form::select('tipo', [
                        'Administrador' => 'Administrador',
                        'Empresa' => 'Empresa',
                    ], null, ['class' => 'form-control', 'placeholder' => '-- Tipo de usuario --']); !!}
                </div>
