				...
				<div class="panel-body">
					...
					{{ Form::token() }}
						...
						<div class="form-group">
							...
							<div class="col-md-10">
					  			<input type="text" name="nombre" class="form-control mi_margen" placeholder="Nombre del proyecto"></input>
					  		</div>
						</div>					  		
						...
						<div class="form-group">
							...
							<div class="col-md-10">
					  			<textarea name="descripcion" class="form-control mi_margen" placeholder="Descripción del proyecto"></textarea>
					  		</div>
						</div>					  		
